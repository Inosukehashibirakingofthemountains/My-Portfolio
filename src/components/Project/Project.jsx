          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a
                  href="https://github.com/Inosukehashibirakingofthemountains?tab=repositories"
                  target="_blank"
                  rel="noreferrer"
                >
                ...
                <a
                  href="https://react-intership.web.app/"
                  target="_blank"
                  rel="noreferrer"
                >
            ...
            <div className="body">
              <h3>
                DriveShare: Rent Cars, Find Drivers, and Embark on Adventures!
              </h3>
              <p>
                {" "}
                Welcome to DriveShare, your one-stop destination for seamless
                car rentals and driver connections! Whether you're a car owner
                looking to earn extra income by renting out your vehicle, a
                driver in need of reliable transportation, or an adventurer
                seeking a convenient way to explore new destinations, DriveShare
                has you covered. With our platform, users can easily list their
                cars for rent, find trusted drivers for their journeys, and book
                trips ranging from a quick day trip to extended 15-day
                adventures. Say goodbye to the hassles of traditional car rental
                services and hello to DriveShare, where every journey is an
